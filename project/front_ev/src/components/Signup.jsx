        ...
        <div className="mx-4 w-full max-w-md space-y-6 rounded-lg bg-white p-6 shadow-lg ">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {(!phone1 || !phone2 || !phone3) && <p className="mt-1 text-sm text-red-500">전화번호를 입력해주세요.</p>}
            </div>
            <div className="flex items-center justify-between">
              <Button
                className="w-full rounded-md bg-[#5b5b8c] px-3 py-2 text-white hover:bg-[#4a4a74]"
