...
#define MIN_ABS_SPEED 130     //수정             // 모터의 최저속도를 설정합니다.   0 ~ 255 값 중 선택
...
double originalSetpoint = 179.4; //수정
...
LMotorController motorController(ENA, IN1, IN2, ENB, IN3, IN4, 1, 0.9);
